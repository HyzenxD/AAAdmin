package com.tawhid.academicassistant.faculty;
...
import com.tawhid.academicassistant.R;
...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Computer Science and Engineering", "Electrical and Electronics Engineering", "Mechanical Engineering","Civil Engineering"};
    ...
    private void insertData()
         {
            ...
            dbRef.child(uniqueKey).setValue(teacherData).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    pd.dismiss();
                    Toast.makeText(AddTeacher.this, "Something went error", Toast.LENGTH_SHORT).show();
                }
            });
        }
